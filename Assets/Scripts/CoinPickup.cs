...
{
    public int coinAmount = 1; // Die Coins, die der Spieler beim Einsammeln erhält.
    ...
    void Start()
    {
        player = PlayerController.instance; // Den PlayerController des Spielers abrufen.
    }
    ...
    private void OnTriggerEnter2D(Collider2D collision) // Wird aufgerufen, wenn das Objekt einen anderen Trigger-Collider berührt.
    {
        ...
        {
           CoinController.instance.AddCoins(coinAmount); // ...Fordere die Erfahrungspunkte für den Spieler an.
